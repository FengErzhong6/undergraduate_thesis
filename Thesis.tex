...
%->> Document settings
%---------------------------------------------------------------------------%
\usepackage[super,myhdr,list,tikz]{Style/artratex}% document settings
...
\usepackage{arydshln}% dashed separators in array environments
...
\bibliography{Biblio/ref,Biblio/hsz}% bibliography
